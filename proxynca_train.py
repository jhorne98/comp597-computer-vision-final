...
savepaths = ['frozen_proxynca_model_resnet50.pth', 'frozen_proxynca_model_resnet18.pth', 'proxynca_model_resnet50.pth', 'proxynca_model_resnet18.pth']
logpaths = ['frozen_training_log_resnet50.txt', 'frozen_training_log_resnet18.txt', 'training_log_resnet50.txt', 'training_log_resnet18.txt']
